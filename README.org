...
=notepad--= requires git, CMake, SDL3, SDL33_ttf, and a C++ compiler.

*Arch:*
#+begin_src bash
sudo pacman -S git cmake sdl3 sdl3_ttf gcc
#+end_src

*Debian/Ubuntu:*
#+begin_src bash
sudo apt install git cmake libsdl3-dev libsdl3-ttf-dev gcc
#+end_src
...
# notepad-- uses Dear ImGui as a git submodule.
git submodule init
...
The executable will be under =notepad--/build/=
